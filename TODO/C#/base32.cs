...
namespace totalLibrary.Cryptography
{
    public class Base32
    {
        public const int InByteSize = 8;
        public const int OutByteSize = 5;
        public const string Base32Alphabet = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
        public static string base32_encrypt(string bytes)
        {
            if (bytes == null)
            {
                return null;
        ...
        public static byte[] base32_decrypt(string base32String)
        {
