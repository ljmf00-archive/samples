...
namespace totalLibrary.Converters
{
    public class Pdfdoc
    {
        public static Microsoft.Office.Interop.Word.Application _Word = new Microsoft.Office.Interop.Word.Application();
        public static object _MissingValue = System.Reflection.Missing.Value;
        public static void PDFfromDOC(string wordFileName, out string pdfFileName)
        {
            _Word.Visible = false;
